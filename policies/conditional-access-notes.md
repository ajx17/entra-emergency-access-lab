...
This lab currently runs on Entra free tier. Conditional Access policy authoring requires Entra ID P1, so the production policy above cannot be fully implemented in this tenant.
